...
from chatterbotaiai.errors import BadRequest, NotFound, Unauthenticated


class Client:
    @classmethod
    def _get_http_headers(cls) -> Dict[str, str]:
        return {"Authorization": f"Bearer {chatterbotai.api_key}"}
    ...
    def request_action(
        ...
        url = f"https://{chatterbotai.api_base}/v1/{action_path}"
    ...
    async def listen_to_execution(cls, address: str) -> Union[str, bytes]:
        ...
        url = f"wss://{chatterbotai.api_base}/ws/v1/execution/{address}/"
